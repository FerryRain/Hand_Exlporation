...
def move_to_new(robot, controller, quat, gpis, hand_pos_now, entities, contact_force, alpha_base=0.025, beta_base=0.10):
...
def run_simulator(sim: sim_utils.SimulationContext, entities):
    ...
    pos = torch.tensor([0, 0.5, 0.0], device="cuda")
    ...
    gpis = init_normal_HE_GPIS_model_2(temp_min, temp_max, temp_bb_min, temp_bb_max, res=100, grid_count=6, store_path="../Results/Exploration_env_stage7_1_3_")
