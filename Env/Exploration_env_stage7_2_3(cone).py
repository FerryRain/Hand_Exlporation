"""
@FileName：Exploration_env_stage7_2_3(cone).py.py
@Description：
@Author：Ferry
@Time：2025 5/19/25 3:54 PM
...
def run_simulator(sim: sim_utils.SimulationContext, entities):
    ...
    gpis = init_normal_HE_GPIS_model_4(temp_min, temp_max, temp_bb_min, temp_bb_max, res=100, grid_count=6, store_path="../Results/Exploration_env_stage7_2_3_")
