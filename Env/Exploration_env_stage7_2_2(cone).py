"""
@FileName：Exploration_env_stage7_2_2(cone).py.py
@Description：
@Author：Ferry
...
def run_simulator(sim: sim_utils.SimulationContext, entities):
    ...
    gpis = init_normal_HE_GPIS_model_3(temp_min, temp_max, temp_bb_min, temp_bb_max, res=100, grid_count=6, store_path="../Results/Exploration_env_stage7_2_")
